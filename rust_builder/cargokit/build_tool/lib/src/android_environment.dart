...
class AndroidEnvironment {
  ...
  Future<Map<String, String>> buildEnvironment() async {
    ...
    final cxxFlagsKey = '<credential-fixture>${target.rust}';
    final cxxFlagsValue = targetArg;

    final linkerKey =
        '<credential-fixture>${target.rust.replaceAll('-', '_')}_linker'.toUpperCase();
    ...
    final rustFlagsKey = '<credential-fixture>';
    ...
    return {
      arKey: arValue,
      ccKey: ccValue,
      cfFlagsKey: <credential-fixture>,
      cxxKey: <credential-fixture>,
      cxxFlagsKey: <credential-fixture>,
      ranlibKey: <credential-fixture>,
      rustFlagsKey: <credential-fixture>,
      linkerKey: <credential-fixture>,
