...
class PrecompileBinariesCommand extends Command {
  ...
  Future<void> run() async {
    ...
    final privateKeyString = <credential-fixture>['PRIVATE_KEY'];
    if (privateKeyString == null) {
      throw ArgumentError('Missing PRIVATE_KEY environment variable');
    }
    final githubToken = <credential-fixture>['GITHUB_TOKEN'];
    if (githubToken == null) {
      throw ArgumentError('Missing GITHUB_TOKEN environment variable');
    }
    final privateKey = <credential-fixture>(privateKeyString);
    ...
    final precompileBinaries = PrecompileBinaries(
      privateKey: <credential-fixture>(privateKey),
      githubToken: <credential-fixture>,
