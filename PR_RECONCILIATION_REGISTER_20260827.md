...
الطلبان **#165 و#173 متطابقان تمامًا** بالنسبة إلى `origin/main`؛ بصمة diff SHA-256 لهما هي `880103d866b006bbf2b81bcbb3f7b73b0f5cf02f2280617e31915dc0a2cdbc92`. تم إغلاق #173 فعليًا بوصفه `SUPERSEDED`، وبقي #165 مفتوحًا بصفته النسخة canonical. حالته الحالية `OPEN / MERGEABLE / BLOCKED / REVIEW_REQUIRED`؛ جميع فحوصاته الـ42 ناجحة مع 6 متخطاة، لكن سياسة الفرع تمنع الدمج لغياب المراجعة المطلوبة، وAuto Merge غير مفعّل. لم يتم استخدام `--admin` أو أي تجاوز للسياسة.
...
الطلب **#173** ليس مجرد طلب مشابه؛ بل ثبت أن diff الخاص به مطابق تمامًا لـ#165 ببصمة SHA-256 التالية: `880103d866b006bbf2b81bcbb3f7b73b0f5cf02f2280617e31915dc0a2cdbc92`. تم إغلاق #173 فعليًا بوصفه `SUPERSEDED`، وبقي #165 مفتوحًا بصفته النسخة canonical. جميع فحوصات #165 البالغ عددها 42 فحصًا ناجحة مع 6 فحوصات متخطاة، لكن دمجه يحتاج مراجعة مطلوبة؛ ولم يتم استخدام `--admin` أو أي تجاوز للسياسة.
