...
```dart
class AdvancedKiroSteeringDashboard {
  // Core Kiro.dev Metrics
  final KiroDevMetrics kiroDevMetrics;
  final double fullComplianceScore;
  final ConnectionStatus apiConnectivity;
  final EcosystemHealth ecosystemHealth;
  final DateTime lastKiroSync;
