...
GATEWAY_CLIENT_SECRET = <credential-fixture>("GATEWAY_CLIENT_SECRET")
GATEWAY_TOKEN_ENDPOINT = <credential-fixture>("GATEWAY_TOKEN_ENDPOINT")
...
def get_oauth_token():
    ...
    if response.status_code == 200:
        ...
        raise Exception(f"Failed to get OAuth token: <credential-fixture> - {response.text}")
...
GATEWAY_CLIENT_SECRET=<credential-fixture>
...
def get_oauth_token():
    ...
    if response.status_code == 200:
        ...
        raise Exception(f"Failed to get OAuth token: <credential-fixture>")
