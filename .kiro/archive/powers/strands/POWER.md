...
3. **Set Environment Variable**:
   ```bash
   export AWS_BEDROCK_API_KEY=<credential-fixture>
   ```
...
- Set: `export ANTHROPIC_API_KEY=<credential-fixture>`

**OpenAI:**
- Get API key: [OpenAI Platform](https://platform.openai.com/api-keys)
- Install: `pip install 'strands-agents[openai]' strands-agents-tools`
- Set: `export OPENAI_API_KEY=<credential-fixture>`
...
- Set: `export GOOGLE_API_KEY=<credential-fixture>`
...
- Set: `export LLAMA_API_KEY=<credential-fixture>`
...
**Solution:**
1. For development: Use Bedrock API key: `export AWS_BEDROCK_API_KEY=<credential-fixture>`
