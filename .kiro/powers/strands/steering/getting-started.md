...
aws configure
# OR
export AWS_ACCESS_KEY_ID=<credential-fixture>
export AWS_SECRET_ACCESS_KEY=<credential-fixture>
...
export ANTHROPIC_API_KEY=<credential-fixture>
```
...
export LLAMA_API_KEY=<credential-fixture>
```
...
export GOOGLE_API_KEY=<credential-fixture>
```
...
export OPENAI_API_KEY=<credential-fixture>
```
