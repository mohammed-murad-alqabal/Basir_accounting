...
User_Personas:
  ...
  Primary_Users:
    ...
    External_Auditor:
      ...
      Access_Level: "<credential-fixture>, audit-specific functions"
  
  Secondary_Users:
    CFO:
      Role: "Strategic financial leadership"
      Key_Needs: "<credential-fixture> reporting, compliance assurance"
    ...
    Tax_Manager:
      ...
      Key_Needs: "<credential-fixture> data extraction" # Post-MVP
```
