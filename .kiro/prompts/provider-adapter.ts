...
export class OpenAIProvider implements AIProvider {
  ...
  generatePrompt(task: string, context: TaskContext): string {
    const basePrompt = `You are an expert Flutter/Dart developer working on basir_accounting_system.`;
  ...
  handleResponse(response: any): ProcessedResponse {
    return {
      ...
      metadata: {
        ...
        tokens_used: <credential-fixture>,
...
export class AnthropicProvider implements AIProvider {
  ...
  costPerToken = <credential-fixture>;
...
<context>
Project: basir_accounting_system - Arabic invoice management app
Architecture: Clean Architecture with Riverpod + Isar
...
- Focus on maintainability and performance
  ...
  handleResponse(response: any): ProcessedResponse {
    return {
      ...
      metadata: {
        model: response.model,
        tokens_used: <credential-fixture> + response.usage.output_tokens,
...
export class BedrockProvider implements AIProvider {
  ...
  costPerToken = <credential-fixture>; // Generally cheaper than direct API
  responseTime = 2500;
...
<enterprise_context>
Application: basir_accounting_system - Invoice Management System
  ...
  handleResponse(response: any): ProcessedResponse {
    ...
    return {
      ...
      metadata: {
        ...
        tokens_used: <credential-fixture>(content),
...
Context:
- Project: basir_accounting_system (Flutter invoice management app)
  ...
  handleResponse(response: any): ProcessedResponse {
    return {
      ...
      metadata: {
        ...
        tokens_used: <credential-fixture>(response.response || response.content),
