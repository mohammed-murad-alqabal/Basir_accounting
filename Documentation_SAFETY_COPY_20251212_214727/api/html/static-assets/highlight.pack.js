...
e.__beforeBegin=T,e.keywords=<credential-fixture>||e.beginKeywords,delete e.beginKeywords,
...
})),e.keywords=<credential-fixture>,e.begin=b(t.beforeMatch,d(t.begin)),e.starts={
...
G;q(e,e.begin,{key:"<credential-fixture>"}),e.begin=f(e.begin,{joinWith:""})}})(e),(e=>{
if(Array.isArray(e.end)){
if(e.skip||e.excludeEnd||e.returnEnd)throw K("skip, excludeEnd, returnEnd not compatible with endScope: {}"),
G
;if("object"!=typeof e.endScope||null===e.endScope)throw K("endScope must be object"),
G;q(e,e.end,{key:"<credential-fixture>"}),e.end=f(e.end,{joinWith:""})}})(e)}function X(e){
function n(n,t){
...
;return"object"==typeof s.keywords&&s.keywords.$pattern&&(s.keywords=<credential-fixture>({},s.keywords),
...
classNameAliases:{keyframePosition:"<credential-fixture>"},contains:[t.BLOCK_COMMENT,{
...
excludeBegin:!0,keywords:"<credential-fixture>",className:"property",relevance:0},x={
...
keyword:"<credential-fixture> as val var vararg get set class object open private protected public noinline crossinline dynamic final enum if else do while for when throw try catch finally import package is in fun override companion reified inline lateinit init interface annotation data sealed internal infix operator out by constructor super tailrec where const inner suspend typealias external expect actual",
...
$pattern:m(/\b\w+/,/#\w+/),keyword:<credential-fixture>(Me),literal:Se},c=[i,s,o],g=[{
