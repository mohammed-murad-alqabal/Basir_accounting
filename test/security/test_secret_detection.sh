...
@test "Example: أنماط أسرار محددة يجب اكتشافها" {
    detect_secrets "const api_key = 'sk_live_123456';"
    detect_secrets "String password = 'mySecretPass123';"
    detect_secrets "final token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9';"
    detect_secrets "const secret = 'my-secret-value';"
    detect_secrets "Authorization: Bearer abc123def456"
    detect_secrets "auth_token = 'token123';"
}
