...
void main() {
  group('CI/CD Integration Tests', () {
    ...
    group('Quality Gates Integration', () {
      ...
      test('should require coverage generation in the quality gate', () {
        // Coverage is emitted only after this test process exits, so asserting
        // coverage/lcov.info here is inherently racy. Verify the CI contract
        // that produces the artifact instead.
        final workflow = File('.github/workflows/quality_gates.yml');
        final content = workflow.readAsStringSync();
