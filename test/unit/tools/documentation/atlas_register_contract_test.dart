...
void main() {
  ...
  test('Atlas inventory represents every legacy screen ID from 001 through 099',
      () {
  ...
  test('Atlas inventory retains observed duplicate and missing source conditions',
      () {
