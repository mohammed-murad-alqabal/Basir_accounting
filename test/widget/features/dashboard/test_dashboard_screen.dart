...
import '../../../mocks/mock_dashboard_charts.dart';

/// Test-specific version of DashboardScreen without complex chart widgets
/// This eliminates timer issues while maintaining full functionality testing
class TestDashboardScreen extends ConsumerStatefulWidget {
  /// Creates test dashboard screen
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // الملخص المالي (ميزة المحاسبة الجديدة) - Removed for testing
            ...
            // Mock charts instead of real ones to avoid timer issues
            MockDashboardCharts(data: data),
            const SizedBox(height: Spacing.xl),
