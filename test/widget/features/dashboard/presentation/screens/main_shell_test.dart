...
void main() {
  group('MainShell - Navigation Structure', () {
    ...
    const testScreens = <Widget>[
      SizedBox.expand(key: ValueKey('screen-home')),
      SizedBox.expand(key: ValueKey('screen-invoices')),
      SizedBox.expand(key: ValueKey('screen-vendors')),
      SizedBox.expand(key: ValueKey('screen-customers')),
      SizedBox.expand(key: ValueKey('screen-inventory')),
      SizedBox.expand(key: ValueKey('screen-assets')),
      SizedBox.expand(key: ValueKey('screen-settings')),
    ];
  ...
  group('MainShell - Semantics', () {
    ...
    const testScreens = <Widget>[
      SizedBox.expand(key: ValueKey('s1')),
      SizedBox.expand(key: ValueKey('s2')),
      SizedBox.expand(key: ValueKey('s3')),
      SizedBox.expand(key: ValueKey('s4')),
      SizedBox.expand(key: ValueKey('s5')),
      SizedBox.expand(key: ValueKey('s6')),
      SizedBox.expand(key: ValueKey('s7')),
    ];
