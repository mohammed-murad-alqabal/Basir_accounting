          ...
          return Padding(
            ...
            child: Semantics(
              ...
              child: FilterChip(
                ...
                label: _isNarrow
                    ? Icon(option.status.semanticIcon,
                        size: IconSizes.xs, color: AppColors.textPrimary)
                    : Text(
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: const Icon(Icons.search_rounded,
            size: IconSizes.sm, color: AppColors.textHint),
        isDense: true,
        filled: true,
    ...
    return Semantics(
      ...
      child: IconButton(
        ...
        icon: const Icon(Icons.download_rounded,
            size: IconSizes.sm, color: AppColors.textPrimary),
