...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  AssetDto dco_decode_asset_dto(dynamic raw) {
    ...
    return AssetDto(
      ...
      purchaseDate: dco_decode_String(arr[5]),
      cost: dco_decode_String(arr[6]),
      salvageValue: dco_decode_String(arr[7]),
  ...
  AssetDto sse_decode_asset_dto(SseDeserializer deserializer) {
    ...
    final var_purchaseDate = sse_decode_String(deserializer);
    final var_cost = sse_decode_String(deserializer);
    final var_salvageValue = sse_decode_String(deserializer);
  ...
  void sse_encode_asset_dto(AssetDto self, SseSerializer serializer) {
    ...
    sse_encode_String(self.purchaseDate, serializer);
    sse_encode_String(self.cost, serializer);
    sse_encode_String(self.salvageValue, serializer);
