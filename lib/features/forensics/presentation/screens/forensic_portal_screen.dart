        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(
                  pulse.isHealthy ? Icons.verified_user : Icons.warning_amber,
      ...
      blocksAsync.when(
        data: (blocks) => ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return _buildBlockItem(context, block, index == blocks.length - 1);
          },
        ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildHashRow('PREV', block.previousHash ?? '0x00000000'),
                  ],
                ),
              ),
            ),
