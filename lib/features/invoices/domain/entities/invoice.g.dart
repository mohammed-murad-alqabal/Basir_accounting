...
_$InvoiceItemImpl _$$InvoiceItemImplFromJson(
  Map<String, dynamic> json,
) => _$InvoiceItemImpl(
  id: json['id'] as String,
  name: json['name'] as String,
  quantity: const DecimalJsonConverter().fromJson(json['quantity'] as String),
  ...
  taxAmount: const DecimalJsonConverter().fromJson(json['taxAmount'] as String),
...
_$InvoiceImpl _$$InvoiceImplFromJson(Map<String, dynamic> json) =>
    _$InvoiceImpl(
      ...
      subtotalAmount: const DecimalJsonConverter().fromJson(
        json['subtotalAmount'] as String,
      ),
      taxAmount: const DecimalJsonConverter().fromJson(
        json['taxAmount'] as String,
      ),
      discountAmount: const DecimalJsonConverter().fromJson(
        json['discountAmount'] as String,
      ),
      totalAmount: const DecimalJsonConverter().fromJson(
        json['totalAmount'] as String,
      ),
      paidAmount: const DecimalJsonConverter().fromJson(
        json['paidAmount'] as String,
      ),
      taxRate: const DecimalJsonConverter().fromJson(json['taxRate'] as String),
      discountRate: const DecimalJsonConverter().fromJson(
        json['discountRate'] as String,
      ),
      exchangeRate: const DecimalJsonConverter().fromJson(
      ...
      zatcaStatus:
          $enumDecodeNullable(
            _$ZatcaSubmissionStatusEnumMap,
            json['zatcaStatus'],
          ) ??
...
Map<String, dynamic> _$$InvoiceImplToJson(
  _$InvoiceImpl instance,
) => <String, dynamic>{
  'id': instance.id,
  ...
  'subtotalAmount': const DecimalJsonConverter().toJson(
    instance.subtotalAmount,
  ),
  'taxAmount': const DecimalJsonConverter().toJson(instance.taxAmount),
  'discountAmount': const DecimalJsonConverter().toJson(
  ...
  'taxRate': const DecimalJsonConverter().toJson(instance.taxRate),
  'discountRate': const DecimalJsonConverter().toJson(instance.discountRate),
  'exchangeRate': const DecimalJsonConverter().toJson(instance.exchangeRate),
