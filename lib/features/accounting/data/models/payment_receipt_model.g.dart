...
extension PaymentReceiptModelByIndex on IsarCollection<PaymentReceiptModel> {
  ...
  List<Id> putAllByPaymentReceiptIdSync(
    List<PaymentReceiptModel> objects, {
    bool saveLinks = true,
  }) {
  ...
  List<Id> putAllByReceiptNumberSync(
    List<PaymentReceiptModel> objects, {
    bool saveLinks = true,
  }) {
...
extension PaymentReceiptModelQueryWhere
  ...
  QueryBuilder<PaymentReceiptModel, PaymentReceiptModel, QAfterWhereClause>
  receiptDateGreaterThan(DateTime receiptDate, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.between(
          indexName: r'receiptDate',
  ...
  QueryBuilder<PaymentReceiptModel, PaymentReceiptModel, QAfterWhereClause>
  receiptDateLessThan(DateTime receiptDate, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.between(
          indexName: r'receiptDate',
...
extension PaymentReceiptModelQueryFilter
    on
        QueryBuilder<
          PaymentReceiptModel,
          PaymentReceiptModel,
  ...
  QueryBuilder<PaymentReceiptModel, PaymentReceiptModel, QAfterFilterCondition>
  paymentReceiptIdEqualTo(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
  ...
  QueryBuilder<PaymentReceiptModel, PaymentReceiptModel, QAfterFilterCondition>
  paymentReceiptIdStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.startsWith(
          property: r'paymentReceiptId',
  ...
  QueryBuilder<PaymentReceiptModel, PaymentReceiptModel, QAfterFilterCondition>
  paymentReceiptIdEndsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.endsWith(
          property: r'paymentReceiptId',
  ...
  paymentReceiptIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'paymentReceiptId', value: ''),
      );
    });
  }
  ...
  paymentReceiptIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'paymentReceiptId', value: ''),
      );
    });
  }
  ...
  receiptDateEqualTo(DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'receiptDate', value: value),
      );
    });
  }

  QueryBuilder<PaymentReceiptModel, PaymentReceiptModel, QAfterFilterCondition>
  receiptDateGreaterThan(DateTime value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
  ...
  QueryBuilder<PaymentReceiptModel, PaymentReceiptModel, QAfterFilterCondition>
  receiptDateLessThan(DateTime value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
...
extension PaymentReceiptModelQueryObject
    on
        QueryBuilder<
          PaymentReceiptModel,
          PaymentReceiptModel,
...
extension PaymentReceiptModelQueryLinks
    on
        QueryBuilder<
          PaymentReceiptModel,
          PaymentReceiptModel,
