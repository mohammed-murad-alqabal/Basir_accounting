...
class DocumentationCLI {
  ...
  Future<int> _runAnalyze(List<String> args) async {
    ...
    try {
      ...
      print('├── Documented elements: ${stats.documentedElements}');
      ...
      for (final result in results) {
        if (result.undocumentedElements.isNotEmpty) {
          ...
          if (dryRun) {
            ...
            print('✅ Generated ${docs.length} docs for ${result.filePath}');
          }
