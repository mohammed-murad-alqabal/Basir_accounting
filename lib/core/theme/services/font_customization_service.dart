...
class FontCustomizationService extends AsyncNotifier<FontCustomizationState> {
  ...
  Future<FontCustomizationState> _loadSettings() async {
    try {
      ...
      final familyKey = _getUserKey(_fontFamilyKey);
      final scaleKey = _getUserKey(_textScaleKey);
  ...
  Future<void> setFontFamily(String fontFamily) async {
    ...
    try {
      final prefs = await SharedPreferences.getInstance();
      final key = _getUserKey(_fontFamilyKey);
  ...
  Future<void> setTextScale(double scale) async {
    ...
    try {
      final prefs = await SharedPreferences.getInstance();
      final key = _getUserKey(_textScaleKey);
