...
class BasserIcons {
  ...
  /// أيقونة السهم للأمام
  static const IconData arrowForward = Icons.arrow_forward_outlined;
  ...
  /// أيقونة الإنترنت
  static const IconData web = Icons.language_outlined;
  ...
  /// أيقونة الضريبة
  static const IconData tax = Icons.receipt_outlined;

  /// أيقونة الخصم
  static const IconData discount = Icons.local_offer_outlined;

  /// أيقونة الإجمالي
  static const IconData total = Icons.calculate_outlined;

  /// أيقونة الحالة
  static const IconData status = Icons.flag_outlined;
  ...
  /// أيقونة النقل
  static const IconData transport = Icons.local_shipping_outlined;
  ...
  /// أيقونة التذكرة
  static const IconData ticket = Icons.local_activity_outlined;

  /// أيقونة الجائزة
  static const IconData award = Icons.emoji_events_outlined;

  /// أيقونة الكأس
  static const IconData trophy = Icons.military_tech_outlined;

  /// أيقونة الميدالية
  static const IconData medal = Icons.workspace_premium_outlined;
}

/// أيقونة مخصصة مع تأثيرات
///
/// widget يعرض أيقونة مع إمكانية إضافة تأثيرات وألوان مخصصة
...
/// أيقونة متحركة
///
/// widget يعرض أيقونة مع تأثير حركي
