...
abstract class _$BasirDatabase extends GeneratedDatabase {
  ...
  late final Index inventoryItemsScopeWarehouseDeletedIdx = Index(
      'inventory_items_scope_warehouse_deleted_idx',
      'CREATE INDEX inventory_items_scope_warehouse_deleted_idx ON inventory_items (scope_key, warehouse_id, is_deleted)');
  late final Index inventoryItemsScopeSkuIdx = Index(
      'inventory_items_scope_sku_idx',
      'CREATE INDEX inventory_items_scope_sku_idx ON inventory_items (scope_key, sku)');
  late final Index inventoryItemsScopeNameArIdx = Index(
      'inventory_items_scope_name_ar_idx',
      'CREATE INDEX inventory_items_scope_name_ar_idx ON inventory_items (scope_key, name_ar)');
...
class $$InventoryItemsTableFilterComposer
    extends Composer<_$BasirDatabase, $InventoryItemsTable> {
...
class $$InventoryItemsTableTableManager extends RootTableManager<
    ...
    (
      InventoryItem,
      BaseReferences<_$BasirDatabase, $InventoryItemsTable, InventoryItem>
    ),
    InventoryItem,
    PrefetchHooks Function()> {
  $$InventoryItemsTableTableManager(
      _$BasirDatabase db, $InventoryItemsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
