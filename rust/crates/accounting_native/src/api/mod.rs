    ...
    fn try_from(dto: AuditMetadataDto) -> Result<Self, Self::Error> {
        ...
        Ok(AuditMetadata {
            ...
            why: WhyInfo {
                ...
                authorization_reference: dto.why.authorization_reference,
            },
            how: HowInfo {
                method: dto.how.method,
                procedure_reference: dto.how.procedure_reference,
                api_endpoint: dto.how.api_endpoint,
            },
        })
    }
}
...
pub(crate) fn map_audit_record_to_dto(
    ...
    AuditRecordDto {
        ...
        why: WhyDto {
            ...
            authorization_reference: record.why.authorization_reference,
        },
        how: HowDto {
            method: record.how.method,
            procedure_reference: record.how.procedure_reference,
            api_endpoint: record.how.api_endpoint,
        },
        hash: record.hash,
