...
pub struct SigningService {
    ...
    private_key: <credential-fixture>,
}

impl SigningService {
    pub fn new(certificate: Certificate, private_key: <credential-fixture>) -> Self {
        Self {
            _certificate: certificate,
            private_key,
        }
...
pub fn sign_ecdsa(private_key_pem: &str, hash_base64: &str) -> Result<String, CryptoError> {
    // Decode private key
    let signing_key = <credential-fixture>::from_pkcs8_pem(private_key_pem)
...
pub fn generate_key_pair() -> (String, String) {
    ...
    let public_key = <credential-fixture>();
