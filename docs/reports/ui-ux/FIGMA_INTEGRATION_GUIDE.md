...
3. **حفظ التوكن بأمان:**
   ...
   export FIGMA_ACCESS_TOKEN="<credential-fixture>"
   ```
...
2. **إضافة Figma Tokens:**
   ```bash
   # في ملف .env
   FIGMA_ACCESS_TOKEN=<credential-fixture>
...
@figma get_file_info --file_key="<credential-fixture>"

# 3. الحصول على عقد الملف
@figma get_file_nodes --file_key="<credential-fixture>"
```
...
@figma get_comments --file_key="<credential-fixture>"

# الحصول على إصدارات الملف
@figma get_file_versions --file_key="<credential-fixture>"
```
...
@figma get_file_info --file_key="<credential-fixture>" --include_styles=true

# الحصول على مكونات التصميم
@figma get_file_nodes --file_key="<credential-fixture>" --node_ids="component_ids"
```
...
# اختبار الاتصال
curl -H "X-Figma-Token: <credential-fixture>" \
...
- [MCP Best Practices](../../guides/kiro_reference/kiro-compliance.md)
