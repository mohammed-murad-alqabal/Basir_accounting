...
| GOV-DOC-001: سجل وثائق حاكم يحدد مصدر الحقيقة وحالة الوثيقة ويمنع الحذف/النقل/الدمج غير المعتمد | `DOCUMENTATION_REGISTER.md` §الغرض والحالة وقواعد تحديد المصدر الحاكم | `P4_DOCUMENTATION_MIGRATION_PLAN_2026-08.md`؛ `AUTHORITY_MODEL.md`؛ `DOCUMENT_OWNERSHIP.md` | `DOCUMENTATION_REGISTER.md` في حالة `DRAFT`، مع خطة MOVE/MERGE/ARCHIVE؛ أضيفت banners تاريخية للوثائق المؤكدة | `governance_engine_test.dart` يثبت metadata والروابط والادعاءات المحكومة؛ لا يوجد contract test شامل لفهرسة كل سجل بعد | [PR #120](https://github.com/mohammed-murad-alqabal/Basir_accounting/pull/120)؛ SHA المدمج `93df611433a62f7935e7aa622d3741c2bb1869d6`؛ بوابات Documentation Governance وdocumentation-coverage وquality gates نجحت | DRAFT | اعتماد Repository Owner، ثم إضافة اختبار contract يثبت وجود GOV-DOC-001 وحقول `last_verified_sha` و`historical_as_of_sha` قبل رفع الحالة إلى `CANONICAL-ACTIVE`. |
